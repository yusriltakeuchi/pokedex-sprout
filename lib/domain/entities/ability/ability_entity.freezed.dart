...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AbilityEntity&&(identical(other.name, name) || other.name == name));
}
...
class _AbilityEntity implements AbilityEntity {
  const _AbilityEntity({@JsonKey(name: 'name') this.name});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AbilityEntity&&(identical(other.name, name) || other.name == name));
}
