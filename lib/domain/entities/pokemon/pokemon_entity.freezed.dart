...
@override
String toString() {
  return 'PokemonEntity(id: $id, name: $name, weight: $weight, order: $order, height: $height, baseExperience: $baseExperience, types: $types, abilities: $abilities, cries: $cries, stats: $stats, sprites: $sprites, species: $species, moves: $moves)';
}
