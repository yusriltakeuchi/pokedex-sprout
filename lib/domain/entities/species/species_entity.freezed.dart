...
@JsonKey(name: 'id') int? get id;@JsonKey(name: 'name') String? get name;@JsonKey(name: 'url') String? get url;@JsonKey(name: 'gender_rate') int? get genderRate;@JsonKey(name: 'egg_groups') List<EggGroupEntity>? get eggGroups;@JsonKey(name: 'hatch_counter') int? get hatchCounter;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SpeciesEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.url, url) || other.url == url)&&(identical(other.genderRate, genderRate) || other.genderRate == genderRate)&&const DeepCollectionEquality().equals(other.eggGroups, eggGroups)&&(identical(other.hatchCounter, hatchCounter) || other.hatchCounter == hatchCounter));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,url,genderRate,const DeepCollectionEquality().hash(eggGroups),hatchCounter);

@override
String toString() {
  return 'SpeciesEntity(id: $id, name: $name, url: $url, genderRate: $genderRate, eggGroups: $eggGroups, hatchCounter: $hatchCounter)';
}
...
@useResult
$Res call({
@JsonKey(name: 'id') int? id,@JsonKey(name: 'name') String? name,@JsonKey(name: 'url') String? url,@JsonKey(name: 'gender_rate') int? genderRate,@JsonKey(name: 'egg_groups') List<EggGroupEntity>? eggGroups,@JsonKey(name: 'hatch_counter') int? hatchCounter
});
...
/// Create a copy of SpeciesEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = freezed,Object? url = freezed,Object? genderRate = freezed,Object? eggGroups = freezed,Object? hatchCounter = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  int? id, @JsonKey(name: 'name')  String? name, @JsonKey(name: 'url')  String? url, @JsonKey(name: 'gender_rate')  int? genderRate, @JsonKey(name: 'egg_groups')  List<EggGroupEntity>? eggGroups, @JsonKey(name: 'hatch_counter')  int? hatchCounter)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SpeciesEntity() when $default != null:
return $default(_that.id,_that.name,_that.url,_that.genderRate,_that.eggGroups,_that.hatchCounter);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  int? id, @JsonKey(name: 'name')  String? name, @JsonKey(name: 'url')  String? url, @JsonKey(name: 'gender_rate')  int? genderRate, @JsonKey(name: 'egg_groups')  List<EggGroupEntity>? eggGroups, @JsonKey(name: 'hatch_counter')  int? hatchCounter)  $default,) {final _that = this;
switch (_that) {
case _SpeciesEntity():
return $default(_that.id,_that.name,_that.url,_that.genderRate,_that.eggGroups,_that.hatchCounter);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'id')  int? id, @JsonKey(name: 'name')  String? name, @JsonKey(name: 'url')  String? url, @JsonKey(name: 'gender_rate')  int? genderRate, @JsonKey(name: 'egg_groups')  List<EggGroupEntity>? eggGroups, @JsonKey(name: 'hatch_counter')  int? hatchCounter)?  $default,) {final _that = this;
switch (_that) {
case _SpeciesEntity() when $default != null:
return $default(_that.id,_that.name,_that.url,_that.genderRate,_that.eggGroups,_that.hatchCounter);case _:
  return null;
...
class _SpeciesEntity implements SpeciesEntity {
  const _SpeciesEntity({@JsonKey(name: 'id') this.id, @JsonKey(name: 'name') this.name, @JsonKey(name: 'url') this.url, @JsonKey(name: 'gender_rate') this.genderRate, @JsonKey(name: 'egg_groups') final  List<EggGroupEntity>? eggGroups, @JsonKey(name: 'hatch_counter') this.hatchCounter}): _eggGroups = eggGroups;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,url,genderRate,const DeepCollectionEquality().hash(_eggGroups),hatchCounter);
...
/// Create a copy of SpeciesEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = freezed,Object? url = freezed,Object? genderRate = freezed,Object? eggGroups = freezed,Object? hatchCounter = freezed,}) {
